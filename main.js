...
import { getRoles, getCompanies } from "./modules/salaryData.js";   // Import the getRoles and getCompanies functions.
import { getAverageSalaryByRole, getAverageSalaryByCompany, getSalaryAtCompany, getIndustryAverageSalary } from "./modules/workAroundModule.js";  // Import the workAroundModule functions.
import { formatNumber } from './modules/utilities.js';
// TODO: Get the companies and roles using the salaryData module.
const companies = getCompanies(); // Get the companies from the salaryData module.
const roles = getRoles(); // Get the roles from the salaryData module.    
